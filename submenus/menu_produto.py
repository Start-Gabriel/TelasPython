...
class MenuProduto:
    def __init__(self):
        ...
        self.title = Text("CADASTRO PRODUTOS", color="white", background_color="black", size=40)
        ...
        self.navegation = Navagation(self.buttons)
        self.draw()
    def draw(self):
    ...
    def __consultar(self):
        ...
        self.consulta = TelaConsulta()
        self.consulta.start()
    def __alterar(self):
        print("Alterar produto")

    def __todos(self):
        print("Listar todos produtos")
